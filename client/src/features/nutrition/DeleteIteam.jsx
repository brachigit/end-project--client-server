import { useDeleteByNameMutation } from "./nutritionApiSlice";
...
const  DeleteIteam = () => {
  const [DeleteFunc, { isLoading }] = useDeleteByNameMutation();
  ...
  const onSubmit = async (data) => {
    console.log(data)
    try {
       DeleteFunc({name:data.name,nutrientType:data.nutrientType});
    } catch (err) {
