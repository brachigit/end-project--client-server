...
const Register= async(req,res)=>
{
 ...
 const cleanedPhone = phone?.trim() === "" ? undefined : phone;

    if (password.length<8||(cleanedPhone&&  cleanedPhone.length<9)){
   ...
   const obj2=await Users.create( {name,username,role:"user",password:hashedPwd,email,address,phone:cleanedPhone})
